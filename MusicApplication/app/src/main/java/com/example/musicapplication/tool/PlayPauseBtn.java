...
public class PlayPauseBtn extends LinearLayout {
    //命名空间
    private static String NAMESPACE = "http://schemas.android.com/apk/res/com.example.musicapplication.tool";
    ...
    public PlayPauseBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 获取图片的Int值
        playImage = attrs.getAttributeResourceValue(NAMESPACE, "play", R.drawable.play_5_gray);//播放
        pauseImage = attrs.getAttributeResourceValue(NAMESPACE, "pause", R.drawable.pause_5_gray);//暂停
        initView();
    }
    ...
    private void initView(){
        View.inflate(getContext(), R.layout.play_pause_btn, this);//把按钮放入view
